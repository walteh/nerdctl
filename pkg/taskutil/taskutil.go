...
func NewTask(ctx context.Context, client *containerd.Client, container containerd.Container,
	attachStreamOpt []string, flagI, flagT, flagD bool, con console.Console, logURI, detachKeys, namespace, dataRoot string, detachC chan<- struct{}) (containerd.Task, error) {
